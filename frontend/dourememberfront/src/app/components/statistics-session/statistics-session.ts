...
export class StatisticsSession implements OnInit, OnDestroy {
  ...
  constructor(private readonly PatientsService: PatientsService,) {
    ...
    this.patientId = this.PatientsService.getUserId()
  ...
  ngOnInit(): void {
    ...
    if (this.patientId != null){
      ...
      this.PatientsService.findAllUserSessionsByUserIdPage(this.patientId, 0).subscribe(pageable => {

    if (this.patientId != null){

              this.sub = this.PatientsService.findAllUserSessionsByUserIdPage(this.patientId, (pageable.totalPages-1))
        .subscribe(list =>
